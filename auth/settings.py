...
SECRET_KEY = 'django-insecure-v4(f(sh!afhe96$sksr9w35pnodqimo=w8o0pe-9kd)f6vu^@&'
...
INSTALLED_APPS = [
    ...
    # here you need to configure your app
    'app',
    'axes',
]
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/home/apycoder/AndroRAT/Screenshots/auth/app/your.log',
        },
    },
    'loggers': {
        'django': {
